...
// source: pb/nt/highway/highway.proto

package highway

import (
	media "github.com/ProtocolScience/AstralGo/client/pb/nt/media"
...
type DataHighwayHead struct {
	...
	LocaleId   uint32               `protobuf:"varint,10,opt"`
	EnvId      uint32               `protobuf:"varint,11,opt"`
}
...
type NTV2RichMediaHighwayExt struct {
	...
	MsgInfoBody []*media.MsgInfoBody `protobuf:"bytes,6,rep"`
